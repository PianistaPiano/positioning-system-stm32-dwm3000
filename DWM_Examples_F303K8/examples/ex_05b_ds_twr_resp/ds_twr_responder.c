...
#define TX_ANT_DLY  ANT_DELAY//16500//16420//16200(4m)//16385
#define RX_ANT_DLY  ANT_DELAY//16500//16420//16200(43m)//16385
...
//static uint8_t rx_poll_msg[] = {0x41, 0x88, 0, 0xCA, 0xDE, 'W', 'A', 'V', 'E', 0x21, 'E', 'E'};
//static uint8_t tx_resp_msg[] = {0x41, 0x88, 0, 0xCA, 0xDE, 'V', 'E', 'W', 'A', 0x10, 0x02, 'E', 'E'};
//static uint8_t rx_final_msg[] = {0x41, 0x88, 0, 0xCA, 0xDE, 'W', 'A', 'V', 'E', 0x23, 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E'};
...
#define POLL_RX_TO_RESP_TX_DLY_UUS (2435 + 190)//(346 + 190)//(2435 + 190)//536//  //2625// 2435 + 190//550//400 // czas ktory potrzebuje stm do uruchomienia tx w responderze plus czas ramki
...
#define RESP_TX_TO_FINAL_RX_DLY_UUS 2358//270//2358//400 czas ktory potrzebuje stm do uruchomienia tx w initiatorze
...
//static float tempvbat;
static char strg[32] = {0};
...
//    tempvbat = dwt_convertrawtemperature(dwt_readtempvbat());
//    sprintf(strg, (unsigned char *)"Module temperature %f°C", tempvbat);
//    test_run_info(strg);													// czytanie tego powinno byc
//																			// po inicjalizacji i konfiguracji
//    tempvbat = dwt_convertrawvoltage(dwt_readtempvbat());
//    sprintf(strg, (unsigned char *)"Module supply voltage %fV",tempvbat);
//    test_run_info(strg);
    ...
    raw_vbat = (uint8_t)(dwt_readtempvbat());
    real_vbat = dwt_convertrawvoltage(raw_vbat);
    sprintf(strg, (const char *)"Module temperature %f C", real_temp);
    test_run_info((unsigned char *)strg);
    sprintf(strg, (const char *)"Module vBat %f V", real_vbat);
	test_run_info((unsigned char *)strg);
    ...
    while (1)
    {
        ...
        { };
        //timtick_1 = __HAL_TIM_GET_COUNTER(&htim2);// tu zacząć odliczanie czasu
        if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
        {
            uint32_t frame_len;
            //test_run_info((unsigned char *)"tutaj 2 \n\r");
            ...
            if (memcmp(rx_buffer, rx_poll_msg, ALL_MSG_COMMON_LEN) == 0)
            {
                ...
                int ret;
                //test_run_info((unsigned char *)"tutaj 3 \n\r");
                ...
                //timtick_2 = __HAL_TIM_GET_COUNTER(&htim2); //albo tu zakonczyć
                //diff = timtick_2 - timtick_1;
                /* If dwt_starttx() returns an error, abandon this ranging exchange and proceed to the next one. See NOTE 11 below. */
                if (ret == DWT_ERROR)
                {
                	//test_run_info((unsigned char *)"tutaj 6 \n\r");
                    continue;
                }
                ...
                if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
                {
                	//test_run_info((unsigned char *)"tutaj 4 \n\r");
                    ...
                    {
                    	//test_run_info((unsigned char *)"tutaj 5 \n\r");
                        ...
                        sprintf(dist_str, "%10.2fm", distance);
                ...
                else
                {
                    ...
                    //test_run_info((unsigned char *)"tutaj 7 \n\r");
                }
            }
        }
        else
        {
            /* Clear RX error/timeout events in the DW IC status register. */
            dwt_write32bitreg(SYS_STATUS_ID, SYS_STATUS_ALL_RX_TO | SYS_STATUS_ALL_RX_ERR);
           // test_run_info((unsigned char *)"tutaj \n\r");
        }
    }
}
#endif
