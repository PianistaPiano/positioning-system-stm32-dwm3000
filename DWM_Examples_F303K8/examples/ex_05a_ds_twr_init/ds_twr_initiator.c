...
#define RNG_DELAY_MS 1000//100//1000


/* Default antenna delay values for 64 MHz PRF. See NOTE 1 below. */
#define ANT_DELAY 16549//16550
#define TX_ANT_DLY ANT_DELAY//16500//16420//16200//16385
#define RX_ANT_DLY ANT_DELAY//16500//16420//16200//16385
...
#define POLL_TX_TO_RESP_RX_DLY_UUS  2435//346//2435//500//3000//2625//2435//2435//900 // czas, ktory potrzebuej stm do uruchomienia tx w responderze
...
#define RESP_RX_TO_FINAL_TX_DLY_UUS (2358 + 190)//(270+190)//(2358 + 190)//460//  //2548 // 2358 + 190//700
...
//    sprintf(strg, (const char *)"Module temperature %f C", tempvbat);
//    test_run_info((unsigned char *)strg);								// z tym sposobe, czytania jest cos nie tak
//																		// byl zle umiejscowiony, przed inicjalizacją
//    tempvbat = dwt_convertrawvoltage(dwt_readtempvbat());				// i konfiguracja
//    sprintf(strg, (const char *)"Module supply voltage %fV",tempvbat);
    ...
    while (1)
    {
        ...
        if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
        {
            ...
            if (memcmp(rx_buffer, rx_resp_msg, ALL_MSG_COMMON_LEN) == 0)
            {
                ...
                int ret;
                //test_run_info("tutaj 3 \n\r");
                /* Retrieve poll transmission and response reception timestamp. */
                poll_tx_ts = get_tx_timestamp_u64();
//                sprintf(testmsg, "ptxts: %d", poll_tx_ts);
//				test_run_info((unsigned char *)testmsg);
                resp_rx_ts = get_rx_timestamp_u64();
//                sprintf(testmsg, "rxts: %d", resp_rx_ts);
//				test_run_info((unsigned char *)testmsg);
