...
{
    0xA8,//0x34,			  /* PG delay. */ A8 - 168 (initiator)
    0xfdfdfdfd,      /* TX power. */
    0x0             /*PG count*/
};
#elif defined(TEST_DS_TWR_RESPONDER_STS)
dwt_txconfig_t txconfig_options =
{
    0xEA,//0x34,			  /* PG delay. */ EA - 234 (responder)
    0xfdfdfdfd,      /* TX power. */
    0x0             /*PG count*/
};
#elif defined(TEST_GET_MSG_FROM_ANCHORS_2)
dwt_txconfig_t txconfig_options =
{
    0xAC,//0xB0,//0x34,           /* PG delay. */
    0xfdfdfdfd,      /* TX power. */
    0x0             /*PG count*/
};
#endif
...
/* Configuration option 17. //tutaj odpowiednia opcja co jest teraz ustawiona
