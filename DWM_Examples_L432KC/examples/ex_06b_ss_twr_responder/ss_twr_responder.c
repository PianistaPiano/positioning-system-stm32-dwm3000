    ...
    while (1)
    {
	   ...
	   { };
        if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
        {
            ...
            frame_len = dwt_read32bitreg(RX_FINFO_ID) & FRAME_LEN_MAX_EX;//dwt_getframelength();
        ...
        else
        {
        	...
        	dwt_write32bitreg(SYS_STATUS_ID, SYS_STATUS_ALL_RX_TO | SYS_STATUS_ALL_RX_ERR);//dwt_writesysstatuslo(SYS_STATUS_ALL_RX_ERR);
        }
    }
}
#endif
