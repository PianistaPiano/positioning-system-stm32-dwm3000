...
#define POLL_TX_TO_RESP_RX_DLY_UUS (290 + CPU_COMP)//(290 + 327) //(290 + CPU_COMP) //
...
#define RESP_RX_TO_FINAL_TX_DLY_UUS (480 + CPU_COMP)//(480 + 290)// //(290 + 190)
...
//#endif /* CONFIG_SPI_SLOW_RATE */
    ...
    sprintf(dist_str, "%d t", uCurrentTrim_val);
