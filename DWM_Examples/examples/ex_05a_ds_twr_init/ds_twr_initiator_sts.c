...
#define ANT_DELAY 16525//16405//16549//16550
...
/* ==== Address of MAIN Initiator is -> 'V', 'F'==== */
/*
...
#define POLL_TX_TO_RESP_RX_DLY_UUS (290 + CPU_COMP_RESP) //(290 + 354)// //(290 + 327)  //(290 + CPU_COMP) //
...
#define RESP_RX_TO_FINAL_TX_DLY_UUS (480 + CPU_COMP_INIT)//((480 - 65) + 333)//(480 + 333)//((480 - 65) + CPU_COMP_INIT) // (480 + 290)// //(290 + 190)
            ...
            if (frame_len <= sizeof(rx_buffer))
            {
                ...
                if (memcmp(rx_buffer, rx_resp_msg, ALL_MSG_COMMON_LEN) == 0)
                {
                    ...
                    if (ret == DWT_SUCCESS)
                    {
                       ...
                       current_anchor = (current_anchor + 1 ) % 4;
                    }
                }
                else
                {
